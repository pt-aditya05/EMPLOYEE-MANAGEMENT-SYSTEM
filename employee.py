...
class Employee :
    def __init__(self,root) :
        ...
        self.root.title("Made by ADITYA SHUKLA")
        ...
        entry_DOB = DateEntry(upper_frame,textvariable=self.dob,font=('arial',11,'bold'),width=20, date_pattern="dd-mm-yyyy")
        ...
        entry_DOJ= DateEntry(upper_frame,textvariable=self.doj,font=('arial',11,'bold'),width=20, date_pattern="dd-mm-yyyy")
